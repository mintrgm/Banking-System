...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String valReligion[] = {"Hindu", "Muslim", "Christian", "Budhism", "Other"};
        ...
        JLabel address = new JLabel("Citizenship No: ");
        address.setFont(new Font("Raleway", Font.BOLD,20));
        address.setBounds(100, 440, 200, 30);
        add(address);
        
        citizenship = new JTextField();
        citizenship.setFont(new Font("Raleway", Font.BOLD, 14));
        citizenship.setBounds(300, 440, 400, 30);
        add(citizenship);
        
        JLabel city = new JLabel("PAN No: ");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
                Conn c = new Conn();
                String query = "insert into signuptwo values('"+formno+"', '"+sreligion+"', '"+scategory+"', '"+sincome+"', '"+seducation+"', '"+soccupation+"', '"+scitizenship+"', '"+span+"', '"+seniorcitizen+"', '"+existingaccount+"')";
